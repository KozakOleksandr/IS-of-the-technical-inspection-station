...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title">Додвти нового механіка</h3>
	</div>
	<div class="card-body">
		<form action="" id="mechanic-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="name" class="control-label">Прізвище, ім'я</label>
                <input name="name" id="name" type="text" class="form-control rounded-0" value="<?php echo isset($name) ? $name : ''; ?>" required>
			</div>
            <div class="form-group">
				<label for="contact" class="control-label">Контакти</label>
            ...
            <div class="form-group">
                ...
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Доступний</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Не доступний</option>
                </select>
			</div>
		</form>
	</div>
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="mechanic-form">Зберегти</button>
		<a class="btn btn-flat btn-default" href="?page=mechanic">Скасувати</a>
	</div>
</div>
<script>
