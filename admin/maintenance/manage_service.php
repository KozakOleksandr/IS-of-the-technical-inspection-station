...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title">Створити послугу</h3>
	</div>
	<div class="card-body">
		<form action="" id="service-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="service" class="control-label">Назва послуги</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="service-form">Зберегти</button>
		<a class="btn btn-flat btn-default" href="?page=maintenance/service">Скасувати</a>
	</div>
</div>
<script>
