...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title"> Звіт про запис на станцію технічного огляду </h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                <div class="form-group col-md-3">
                    <label for="date_start">Початкова дата</label>
                    <input type="date" class="form-control form-control-sm" name="date_start" value="<?php echo date("Y-m-d",strtotime($date_start)) ?>">
                </div>
                <div class="form-group col-md-3">
                    <label for="date_start">Кінцева дата</label>
                    <input type="date" class="form-control form-control-sm" name="date_end" value="<?php echo date("Y-m-d",strtotime($date_end)) ?>">
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-primary btn-sm"><i class="fa fa-filter"></i> Фільтрувати</button>
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-success btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> Друкувати</button>
                </div>
            </div>
        </form>
        <hr>
        <div id="printable">
            <div>
                <h4 class="text-center m-0"> Система управління обслуговуванням транспортних засобів </h4>
                <h3 class="text-center m-0"><b>Звіт про запис на обслуговування</b></h3>
                <p class="text-center m-0">Час між <?php echo $date_start ?> та <?php echo $date_end ?></p>
                <hr>
            </div>
            <table class="table table-bordered">
                ...
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Дата та час</th>
                        <th>Повне ім'я власнака</th>
                        <th>ВІН-код автомобіля</th>
                        <th>Реєстраційний номер ТЗ</th>
                        <th>Присвоєно до</th>
                        <th>Послуга</th>
                        <th>Статус</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class='text-center'>
                            ...
                            <?php elseif($row['status'] == 2): ?>
                                <span class="badge badge-warning">В-прогресі</span>
                    ...
                    <tr>
                        <td class="text-center" colspan="6">Немає даних...</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
