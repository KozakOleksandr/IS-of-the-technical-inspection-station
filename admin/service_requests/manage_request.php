    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Марка автомобіля</label>
                ...
                <div class="form-group">
                    ...
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        <option <?php echo isset($service_type) && $service_type == 'Drop Off' ? "selected" : '' ?>>Клієнт доставить сам</option>
                        <option <?php echo isset($service_type) && $service_type == 'Pick Up' ? "selected" : '' ?>>Забрати автомобіль</option>
                    </select>
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>В-очікуванні</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>Підтверджено</option>
                        <option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ?>>У-прогресі</option>
                        <option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>Готово</option>
                        <option value="4" <?php echo isset($status) && $status == 4 ? "selected" : '' ?>>Скасовано</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Зберегти запис</button>
