...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Інвентар</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Початкова кількість</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="inventory-form">Зберегти</button>
		<a class="btn btn-flat btn-default" href="?page=inventory">Скасувати</a>
	</div>
</div>
<script>
