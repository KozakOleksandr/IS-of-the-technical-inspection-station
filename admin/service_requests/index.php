...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Перелік записів на обслуговування</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Додати новий запис</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td class="text-center">
								...
								<?php elseif($row['status'] == 2): ?>
									<span class="badge badge-warning">У-процесі</span>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> Переглянути</a>
				                    ...
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span> Видалити</a>
				                  </div>
							</td>
						</tr>
					<?php endwhile; ?>
