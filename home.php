 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            <h1 class="display-4 fw-bolder"> Станція технічного огляду </h1>
            <p class="lead fw-normal text-white-50 mb-0">Ми подбаємо про ваш автомобіль!</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Записатися на сервіс</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                <h3 class="text-center">Ми обслуговуємо:</h3>
            ...
            <div class="col-md-8">
                <h3 class="text-center">Наші послуги</h3>
                <hr class="bg-primary opacity-100">
                <div class="form-group">
                <div class="input-group mb-3">
                    <input type="search" id="search" class="form-control" placeholder="Пошук послуг" aria-label="Пошук послуг" aria-describedby="basic-addon2">
                ...
                <div id="noResult" style="display:none" class="text-center"><b>Немає результату</b></div>
            </div>
        </div>
    </div>
</section>
